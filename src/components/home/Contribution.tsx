            ...
            <div className="row justify-content-center">
               <div className="col-lg-10">
                  ...
                  <div className="contribution-btn">
                     <Link to="#" className="btn">Purchase a Token</Link>
                     <Link to="https://cryptoshield-1.gitbook.io/gentialai-docs" target="_blank" className="btn btn-two">Read White Paper</Link>
                  </div>
               </div>
            </div>
         </div>
